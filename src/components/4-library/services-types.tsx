    ...
    <div className="bg-zinc-100 p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
          <div className="bg-white p-6 rounded-lg shadow-md hover:bg-gray-200 hover:transform hover:scale-110 transition-transform">
          ...
          <div className="bg-purple-500 text-white p-6 rounded-lg shadow-md hover:bg-purple-600 hover:transform hover:scale-110 transition-transform">
