        ...
        <div className="bg-zinc-100 p-6 pb-20">
            <div className="max-w-[1000px] mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mt-16 text-center">
                    <div className="bg-gray-50 p-8 rounded-lg shadow-md hover:bg-brand-purple hover:text-white hover:transform hover:scale-105 transition-transform relative">
