          ...
          <div className="bg-gradient-to-r from-green-400 to-green-200 p-6 rounded-lg">
            <div className="flex flex-col lg:flex-row items-center lg:space-x-8">
              <div className="flex-1 mb-6 lg:mb-0">
                ...
                <img src="https://placehold.co/300x200" alt="Desktop view" className="mx-auto lg:mx-0 mb-4 lg:mb-0" />
              </div>
              <div className="flex-1">
                ...
                <div className="flex space-x-4">
                  <img src="https://placehold.co/100x150" alt="Tablet view" className="w-1/2" />
                  <img src="https://placehold.co/100x150" alt="Mobile view" className="w-1/2" />
                </div>
              </div>
            </div>
            <div className="mt-8">
