...
export function ContactForm(props: ContactFormProps) {
    ...
    return (
        <section className="bg-brand-blue flex flex-col justify-center" >
            ...
            <div className="w-[90%] xl:max-w-5xl min-h-[880px] mx-4 bg-white md:mx-auto rounded-3xl shadow-md">
                <iframe
                    title="contact form"
