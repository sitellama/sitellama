      ...
      <div className="min-h-screen flex justify-center items-center">
        <div>
          ...
          <div className="pt-24 flex flex-row">
            {/* Basic Card */}
            <div className="w-96 p-8 bg-white text-center rounded-3xl pr-16 shadow-xl hover:scale-105 transition-transform">
            ...
            {/* Startup Card */}
            <div className="w-80 p-8 bg-gray-900 text-center rounded-3xl text-white border-4 shadow-xl border-white transform scale-125 hover:scale-105 transition-transform">
              ...
              <div className="pt-8">
                ...
                <p>{"You also get this!"}</p>
                <p>{"But also this too!"}</p>              </div>
              <div className="absolute top-4 right-4">
                <p className="bg-blue-700 font-semibold px-4 py-1 rounded-full uppercase text-xs">Popular</p>
              </div>
            </div>
            {/* Enterprise Card */}
            <div className="w-96 p-8 bg-white text-center rounded-3xl pl-16 shadow-xl hover:scale-105 transition-transform">
