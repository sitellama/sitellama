...
![background-position:left_top,right_bottom] \
!bg-no-repeat \
";

const cardHeaderClasses = "bg-gray-50 p-8 rounded-3xl shadow-md hover:bg-brand-purple hover:text-white hover:transform hover:scale-105 transition-transform relative";
const hClasses = "text-lg font-bold mb-2 text-zinc-600 before:content-empty before:block before:inset-0 before:absolute hover:text-white";

const left = `url(${techLeft})`;
const right = `url(${techRigth})`;
const leftRightStyles = { background: `${left}, ${right}` }; 
